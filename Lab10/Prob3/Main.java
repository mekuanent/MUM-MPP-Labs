...
public class Main {
	...
	public static boolean contains3(List<? extends Employee> list, Employee e,
									BiPredicate<Employee,? super Employee> pred2) {
		for(Employee emp: list) {
			if(emp == null && e == null) return true;
			if(emp == null || e == null) continue;
			if(pred2.test(emp, e)) return true;
	...
	public static boolean contains4(List<? extends Account> list, Account e,
									BiPredicate<Account, Account> pred2) {
		for(Account acc: list) {
			if(acc == null && e == null) return true;
			if(acc == null || e == null) continue;
			if(pred2.test(acc, e)) return true;
		}
		return false;
	}
